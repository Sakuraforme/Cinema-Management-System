/*
 ...
 Source Schema         : no125_weipiao

 Target Server Type    : MySQL
 Target Server Version : 80030
 File Encoding         : 65001

 Date: 26/11/2024 22:42:22
*/
...
CREATE TABLE `t_admin_menu`  (
  ...
  `permission` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '具体权限',
...
CREATE TABLE `t_admin_user`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '昵称',
  `username` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '用户名',
  `password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '密码',
  `cineam_id` int(0) NULL DEFAULT NULL COMMENT '相关影院',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `t_admin_user` VALUES (1, 'https://ww3.sinaimg.cn/mw690/d315af46ly1hnn5btbjr5j20j60j7mzv.jpg', '管理员', 'admin', '123456', NULL);
INSERT INTO `t_admin_user` VALUES (2, 'https://ww3.sinaimg.cn/mw690/d315af46ly1hnn5btbjr5j20j60j7mzv.jpg', '太平洋影城（深圳新城汇店）', 'test1', '123456', 18);
INSERT INTO `t_admin_user` VALUES (4, 'https://ww3.sinaimg.cn/mw690/d315af46ly1hnn5btbjr5j20j60j7mzv.jpg', '华影金娱巨幕电影城', 'test2', '123456', 2);
...
CREATE TABLE `t_banner`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `img` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '轮播图',
  `url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '跳转链接',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of t_banner
-- ----------------------------
INSERT INTO `t_banner` VALUES (6, 'http://localhost:8080/upFile/banner_1.png', NULL);
INSERT INTO `t_banner` VALUES (7, 'http://localhost:8080/upFile/banner_3.png', NULL);
INSERT INTO `t_banner` VALUES (8, 'http://localhost:8080/upFile/banner_2.png', NULL);
INSERT INTO `t_banner` VALUES (9, 'http://localhost:8080/upFile/banner_4.png', NULL);
...
CREATE TABLE `t_cinema`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `nm` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '电影院名',
  `brand_id` int(0) NULL DEFAULT NULL COMMENT '所属品牌',
  `addr` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电影院地址',
...
CREATE TABLE `t_cinema_brand`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `brand` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '大地影院\r\n星美国际影城\r\n中影国际影城\r\n万达影城\r\n特色厅',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_comment`  (
  ...
  `movie_id` int(0) NOT NULL COMMENT '电影id',
  ...
  `approve` int(0) NOT NULL DEFAULT 0 COMMENT '点赞数',
...
CREATE TABLE `t_days`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `cinema_id` int(0) NOT NULL COMMENT '所属影院',
  `movie_id` int(0) NOT NULL COMMENT '所属电影',
...
CREATE TABLE `t_hall`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `cinema_id` int(0) NOT NULL COMMENT '所属影院',
  `hall_type_id` int(0) NULL DEFAULT NULL COMMENT '厅的特色',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `t_hall_type`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `hallType` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '特色厅',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_movie`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `nm` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '电影名',
  `enm` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电影英文名',
  `cat` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电影类型',
  `dir` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '导演',
  `img` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '宣传海报',
  `version` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '播放类型（3d / imax）',
  `dra` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '剧情描述',
  `sc` double(255, 1) NULL DEFAULT 0.0 COMMENT '评分',
  `snum` int(0) NULL DEFAULT 0 COMMENT '评分人数',
  `star` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '明星演员',
  `src` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '上映地区',
  `language` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '语言',
  `dur` int(0) NULL DEFAULT NULL COMMENT '电影时长',
  `globalReleased` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否上映过',
  `wish` bigint(0) NULL DEFAULT 0 COMMENT '想看的人数',
  `watched` int(0) NULL DEFAULT 0 COMMENT '观看人数',
  `rt` date NULL DEFAULT NULL COMMENT '上映日期',
  `showst` int(0) NOT NULL DEFAULT 1 COMMENT '状态：1想看 2预售 3上映 ',
  `video_img` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预告视频图片',
  `video_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预告视频的名字',
  `video_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预告视频的url',
  `photos` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电影海报',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_order`  (
  ...
  `item_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '类型：电影票、小吃',
  `relate_id` int(0) NOT NULL COMMENT '电影票：time_id；小吃：cinema_id',
  `describe` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电影票：座位信息；小吃：数量',
  `order_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '随机订单号',
  `order_uid` int(0) NOT NULL COMMENT '用户id',
...
CREATE TABLE `t_seat`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `hall_id` int(0) NOT NULL COMMENT '所属的影厅id',
  `y_coord` int(0) NOT NULL COMMENT '行',
  `x_coord` int(0) NOT NULL COMMENT '列',
  `status` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '座位状态：有座 ok，无座booked',
  `type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '座位类型：danren，road',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 3390 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_snack`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `cinema_id` int(0) NOT NULL COMMENT '所属影院',
  `image_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '显示图片',
  `first_title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '套餐名称',
  `second_title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '详细描述',
  `price` decimal(10, 2) NOT NULL COMMENT '价格',
  `cur_number` int(0) NULL DEFAULT NULL COMMENT '已售数目',
  `total_number` int(0) NULL DEFAULT NULL COMMENT '总数',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `cinema_id`(`cinema_id`) USING BTREE,
...
INSERT INTO `t_snack` VALUES (2, 1, 'http://localhost:8080/upFile/image.png', '套餐2号', '爆米花1桶+热饮1杯', 32.90, 26, 10000001);
...
INSERT INTO `t_snack` VALUES (32, 10, 'http://localhost:8080/upFile/back-background.jpg', '套餐2号', '爆米花1桶+热饮1杯', 32.90, 30, 9999997);
...
CREATE TABLE `t_times`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `days_id` int(0) NOT NULL COMMENT '所属档期',
  `hall_id` int(0) NOT NULL COMMENT '安排的厅号',
...
CREATE TABLE `t_user`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `avatar_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '头像url',
  `nick_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '用户昵称',
  `gender` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '性别',
  `open_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'open_id',
